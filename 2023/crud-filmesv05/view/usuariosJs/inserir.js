import { limparSpan, exibirMensagem, exibrMensagemErro } from "../utilJs/funcoesUtil.js";
...
let usuarioInserirFetch = function(){
    let usuario = {
        ...
        "login": document.querySelector('#form-inserir').querySelector('#login').valeu,
        "senha": document.querySelector('#form-inserir').querySelector('#senha').valeu
    };
    let configMetodo = {
        method: "POST"
